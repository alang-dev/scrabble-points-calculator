  ...
  return (
    <>
      <div className={cn("flex justify-center gap-4", className)}>
        ...
        <IconButton icon={CloudUpload} onClick={handleSave} disabled={!canSave} data-testid="save-button">
          Save Score
        </IconButton>
        <IconButton icon={BarChart3} onClick={handleViewTopScores} data-testid="view-top-scores-button">
          View Top Scores
        </IconButton>
      </div>
